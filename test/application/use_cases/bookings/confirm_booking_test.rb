require 'test_helper'
require_relative '../../../../app/application/use_cases/bookings/confirm_booking'
  ...
  module UseCases
    module Bookings
      class ConfirmBookingTest < ActiveSupport::TestCase
        ...
        test "confirms booking successfully" do
          # Mock booking repository to return the booking
          @booking_repository.expect :find, @booking, [1]
          
          # Mock booking service to confirm the booking
          @booking_service.expect :confirm_booking, { success: true, booking: @booking }, [@booking]
          ...
          @notification_service.expect :create_notification, true, [2, "Your booking (ID: 1) has been confirmed.", 'system']
          
          # Mock email notification service to send an email
          @email_notification_service.expect :send_email, true, [@user.email, "Booking Confirmation", "Your booking (ID: 1) has been confirmed."]
        ...
        test "handles booking service failure" do
          ...
          # Mock booking service to fail confirmation
          @booking_service.expect :confirm_booking, { success: false, message: "Cannot confirm booking" }, [@booking]
          ...
          # Verify the result
          assert_not result[:success]
          assert_equal "Cannot confirm booking", result[:message]
