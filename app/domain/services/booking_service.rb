...
# This is necessary because Zeitwerk expects app/domain/services/booking_service.rb to define BookingService
BookingService = Domain::Services::BookingService
