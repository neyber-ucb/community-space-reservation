...
# This is necessary because Zeitwerk expects app/interfaces/controllers/api/v1/users_controller.rb to define UsersController
UsersController = Interfaces::Controllers::Api::V1::UsersController
