...
# This is necessary because Zeitwerk expects app/application/use_cases/bookings/create_booking.rb to define CreateBooking
CreateBooking = Application::UseCases::Bookings::CreateBooking
